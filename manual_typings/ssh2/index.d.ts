...
declare module "ssh2" {
    ...
    export interface PseudoTtySettings {
        /**
    ...
    export interface ForwardInCallback {
    ...
    export interface SftpCallback {
        (err?: Error, sftp?: Sftp.SFTPWrapper): void;
    }
    ...
    export interface ServerStderr extends NodeJS.WritableStream {
    ...
    export namespace Sftp {
        ...
        export interface SFTPWrapper extends NodeJS.EventEmitter {
